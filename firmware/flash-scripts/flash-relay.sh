#!/bin/bash
# TonbilTerm - Relay Firmware Flash Script
...
echo ""
echo "==================================="
echo " TonbilTerm Relay Firmware Yukleyici"
echo "==================================="
echo ""
...
# ----------------------------------
echo ""
echo "Relay firmware derleniyor ve yukleniyor..."
...
if [ ! -f "$RELAY_DIR/platformio.ini" ]; then
    echo "[HATA] platformio.ini bulunamadi!"
    echo "Relay firmware kaynak dosyalari eksik."
    echo "Beklenen konum: $RELAY_DIR/"
    exit 1
fi
...
if [ $? -eq 0 ]; then
    echo ""
    echo "==================================="
    echo " BASARILI! Relay firmware yuklendi"
    echo "==================================="
    echo ""
    echo "Sonraki adimlar:"
    echo "  1. ESP32'yi USB'den cikarin"
    echo "  2. Role modulune yerlestirin"
    echo "  3. Guc verin"
    echo "  4. WiFi ayari icin 'TonbilRelay-XXXX' agina baglanin"
