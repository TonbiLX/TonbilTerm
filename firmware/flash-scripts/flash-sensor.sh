#!/bin/bash
# TonbilTerm - Sensor Firmware Flash Script
...
echo ""
echo "==================================="
echo " TonbilTerm Sensor Firmware Yukleyici"
echo "==================================="
echo ""
...
# macOS: /dev/cu.usbserial* veya /dev/cu.SLAB*
...
# ----------------------------------
echo ""
echo "Sensor firmware derleniyor ve yukleniyor..."
...
if [ ! -f "$SENSOR_DIR/platformio.ini" ]; then
    echo "[HATA] platformio.ini bulunamadi!"
    echo "Sensor firmware kaynak dosyalari eksik."
    echo "Beklenen konum: $SENSOR_DIR/"
    exit 1
fi
...
if [ $? -eq 0 ]; then
    echo ""
    echo "==================================="
    echo " BASARILI! Sensor firmware yuklendi"
    echo "==================================="
    echo ""
    echo "Sonraki adimlar:"
    echo "  1. ESP32'yi USB'den cikarin"
    echo "  2. Sensor modulune yerlestirin"
    echo "  3. Guc verin"
    echo "  4. WiFi ayari icin 'TonbilSensor-XXXX' agina baglanin"
